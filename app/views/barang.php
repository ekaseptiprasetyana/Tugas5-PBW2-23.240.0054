            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <a href="index.php?page=edit_barang&id_barang=<?= $item["id_barang"] ?>" class="btn btn-warning btn-sm" onclick="return confirm('Apakah anda yakin ingin mengedit data barang ini?');">Edit</a>
                      <a href="index.php?page=delete_barang&id_barang=<?= $item['id_barang'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data barang ini?')">Hapus</a>
                    </td>
                </tr>
                <?php
                    }
