...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 h-100 min-vh-100">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TOKO EKA</span>
    </a>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="index.php?page=edit_plg&id_pelanggan=<?= $item["id_pelanggan"] ?>" class="btn btn-warning btn-sm" onclick="return confirm('Apakah Anda yakin ingin mengedit data pelanggan ini?');">Edit</a>
                  <a href="index.php?page=delete_plg&id_pelanggan=<?= $item['id_pelanggan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data pelanggan ini?')">Hapus</a>
                </td>
              </tr>
              <?php
                  }
  ...
  <footer class="main-footer">
    ...
    <strong>&copy;<a href="#">23.240.0054 Eka Septi Prasetyana</a>.</strong> All rights reserved.
  </footer>
